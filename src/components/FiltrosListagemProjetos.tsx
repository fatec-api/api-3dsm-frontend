...
interface FiltrosListagemProjetosProps {
    ...
    onFilterChange: (filtros: {
        ...
        tipoProjeto: string;
        cliente: string;
        visualizacaoFinanceira: boolean;
    }) => void;
}
...
export default function FiltrosListagemProjetos({
    ...
    const limparFiltros = () => {
        ...
        setStatusProjeto("");
        setProgresso("");
        setVisualizacaoFinanceira(false);
    };
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center p-5 mb-4 gap-4 flex-wrap">
            <div>
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    type="button"
                    onClick={() => setVisualizacaoFinanceira((prev) => !prev)}
